...
public class RedBlackTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    private void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        // If child is leftChild of parent, perform a right rotation
        if (parent.leftChild == child) {
            ...
            throw new IllegalArgumentException(
                    "Provided child and parent node references are not related as child/parent.");
        }
    }

    /**
     * Resolves a red child under a red parent red black tree property violations that are introduced by inserting new
     * nodes into a red black tree. While doing so, it also preserves all other red black tree properties
     *
     * @param redNode is a newly added red node
     */
    public void enforceRBTreePropertiesAfterInsert(Node<T> redNode) {
        // If the new red node is the root node or its parent is black or the root node, don't do anything
        if (redNode == root || redNode.parent.isBlack) {
            return;
        }
        ...
        } else if (!redNode.parent.isLeftChild() && (redNode.parent.parent.leftChild == null
